...
const steps = [
  {
    ...
    icon: <FaRegClipboard className="w-4 h-4 md:w-8 md:h-8 text-white" />,
    bgColor: "bg-blue-500",
  },
  {
    title: "Set Reminders",
    ...
    icon: <FaBell className="w-4 h-4 md:w-8 md:h-8 text-white" />,
  ...
  },
  {
    ...
    icon: <FaChartLine className="w-4 h-4 md:w-8 md:h-8 text-white" />,
  ...
  },
  {
    ...
    icon: <FaUsers className="w-4 h-4 md:w-8 md:h-8 text-white" />,
          ...
          <div className="relative border-l-2 border-gray-300 ml-4 md:ml-12">
            {steps.map((step, index) => (
              ...
              >
                {/* Step Number / Icon */}
                <div
                  className={`flex items-center justify-center w-6 h-6 md:w-12 md:h-12 rounded-full ${step.bgColor} text-white md:font-bold`}
                >
                  {step.icon}
                </div>
                ...
                <div className="flex-1">
                  <h3 className="text-primary md:text-xl font-bold mb-1">
                    {step.title}
                  </h3>
